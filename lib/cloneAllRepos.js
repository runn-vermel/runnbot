...
var cloneRepos = (function() {
  ...
  var getTeams = function() {
    console.log(colors.green("Getting Org Teams..."));
  ...
  var parseTeamId = function(teams) {
    console.log(colors.green("Finding requested Team Id..."));
    ...
    if (foundTeam.length) {
      ...
      console.log(colors.green("Found Team Id!"));
  ...
  */
  var getRepos = function(teamId) {
    console.log(colors.green("Getting a list of Team Repositories..."));
    function pager(res) {
  ...
  var removePrivateRepos = function(fullReposList) {
    console.log(colors.yellow("Removing Private repositories from list..."));
  ...
  var removeExcludedRepos = function(fullReposList) {
    console.log(colors.yellow("Removing Excluded Repositories from list..."));
  ...
  var createRootDirectory = function() {
    console.log(colors.green("Creating the local Path " + shared.localPath));
  ...
  var cloneAllRepos = function(fullReposList) {
    console.log(colors.green("Cloning all the repositories... this will take a while."));
  ...
  var cloneRepo = function(repo) {
   ...
   var main = function() {
     ...
     .then((n) => getTeams(n))
            ...
            .then((n) => {
              console.log(colors.green("Successfully cloned the repositories!"));

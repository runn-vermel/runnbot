...
var createChangedRepoList = (function() {
  ...
  var createChangedRepoList = function(dirlist) {
    return Promise.all(dirlist.map((dir) => checkDir(dir)));
  };
  ...
  /**
   * our Main function. calls a function that creates a list of changed repos, and takes that list , and removes the nulls from it
  ...
  var main = function(dirList) {
      ...
      .then((dirList) => removeNullFromList(dirList));
  };

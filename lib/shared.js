...
shared.designReposOnly = (argv.designReposOnly) ? argv.designReposOnly : false;
shared.initialRunn = (argv.initialRunn) ? argv.initialRunn : false;
shared.teamName = (argv.teamName) ? argv.teamName : 'Px';
shared.orgName = (argv.orgName)? argv.orgName : 'PredixDev';
shared.dryRunn= (argv.dryRunn) ? argv.dryRunn : true;

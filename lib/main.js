...
var getDirList = require("./getDirList");
var Promise = require("bluebird");

//add your code here
var runnTask = requiredParamChecker.main()
.then(getDirList.main)
.then((dirList) => {
  console.log(dirList);
  debugger;
  return (shared.initialRunn) ?  cloneRepos.main() :  resetRepos.main(dirList);
})
.then((dirList) => {
...
.then(() => {
  if (shared.dryRunn) return Promise.resolve();
  return release.main();
})
